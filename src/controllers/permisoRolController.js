...
class PermisoRolController {
  ...
  static getAllPermisosRoles = async (req, res) => {
    try {
      const response = await PermisoRolService.getAll();
  ...
  static getPermisoRolById = async (req, res) => {
    ...
    try {
      ...
      const response = await PermisoRolService.getById(id);
  ...
  static createPermisoRol = async (req, res) => {
    ...
    try {
      ...
      const response = await PermisoRolService.create(permisoRol);
  ...
  static updatePermisoRol = async (req, res) => {
    ...
    try {
      ...
      const response = await PermisoRolService.update(id, permisoRol);
      // Validamos que la respuesta no tenga error
      if (response.error) {
        // Llamamos el provider para centralizar los mensajes de respuesta
        return ResponseProvider.error(res, response.message, response.code);
  ...
  static deletePermisoRol = async (req, res) => {
    ...
    try {
      ...
      const response = await PermisoRolService.delete(id);
